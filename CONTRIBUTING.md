# Contributing to the Lion ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.lionswap.app/code/contributing) first.
...
Translation in crowdin: `%asset% Earned` [link](https://crowdin.com/translate/lionswap/8/en-de#330)
